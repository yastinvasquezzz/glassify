...
export const PersistentPlayer: React.FC = () => {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-40 px-3 pb-3 pt-0 pointer-events-none select-none">
        <GlassPanel
          className="w-full max-w-7xl mx-auto p-3 flex flex-col md:flex-row items-center justify-between gap-3 pointer-events-auto border-white/20 bg-slate-950/85 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.7)]"
          intensity="heavy"
          glow
        >
          {/* Track Info (Left) */}
          <div className="flex items-center gap-3 w-full md:w-1/4">
            ...
            {/* Plus (+) Button to Add to Playlist */}
            <button
          ...
          {/* Player Controls & Progress Bar (Center) */}
          <div className="flex flex-col items-center gap-1.5 w-full md:w-2/4">
            <div className="flex items-center gap-4">
              ...
              {/* SOLID VIBRANT SPOTIFY GREEN PLAY/PAUSE BUTTON */}
              <button
